...
//				if (scores[cp]==null) continue; 
	...
	/* (non-Javadoc)
	 * @see edu.jhu.coe.classify.Linearizer#getNGrammarWeights()
	 */
	...
	/* (non-Javadoc)
	 * @see edu.jhu.coe.classify.Linearizer#getNLexiconWeights()
	 */
	...
	/* (non-Javadoc)
	 * @see edu.jhu.coe.classify.Linearizer#getNSpanWeights()
	 */
