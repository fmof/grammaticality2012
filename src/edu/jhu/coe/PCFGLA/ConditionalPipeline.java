...
import edu.jhu.coe.PCFGLA.ConditionalTrainer.Options;
...
public class ConditionalPipeline {
	...
	public static void main(String[] args) {
		...
		{
		baselineCondArgs = addOptions(args, new String[]{"-out", nextFile.toString(), /*"-baseline",*/ "-cons",  dirName+"/"+baseName+"0", "-initializeZero", "-doNOTprojectConstraints", "-noSplit", "-doConditional"});//, 
		}
