...
public class SimpleLexicon implements java.io.Serializable, Lexicon {
     ...
     */
    @SuppressWarnings("unchecked")
	public SimpleLexicon splitAllStates(short[] numNonInternalBeforeLatestCouple, int[] offset, int[] counts, boolean moreSubstatesThanCounts, int mode) {
    ...
    public SimpleLexicon propagateHypothesizedCouplings(LatentStatistics LS, Set</*Map<Pair<Integer,Integer>, */BerkeleyCompatibleFragment> easyPreterminalCouplingMap, short[] numSigsPerTag, double gamma){
	throw new Error("SimpleLexicon.propagateHypothesizedLexicon(...) is not currently implemented... (sorry!)");
    }
    ...
    /* (non-Javadoc)
     * @see edu.jhu.coe.HDPPCFG.LexiconInterface#getSmoothingParams()
     */
    ...
    /* (non-Javadoc)
     * @see edu.jhu.coe.HDPPCFG.LexiconInterface#logarithmMode()
     */
    ...
    /* (non-Javadoc)
     * @see edu.jhu.coe.PCFGLA.Lexicon#scoreSignature(java.lang.String, short, int)
     */
    ...
    /* (non-Javadoc)
     * @see edu.jhu.coe.PCFGLA.Lexicon#scoreWord(java.lang.String, short)
     */
    ...
    */
    ...
    /* (non-Javadoc)
     * @see edu.jhu.coe.PCFGLA.Lexicon#computeScores()
     */
