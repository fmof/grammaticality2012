...
import edu.jhu.coe.PCFGLA.GrammarTrainer.Options;
...
import edu.jhu.coe.io.PTBLineLexer;
import edu.jhu.coe.io.PTBTokenizer;
import edu.jhu.coe.io.PTBLexer;
import edu.jhu.coe.syntax.StateSet;
import edu.jhu.coe.syntax.Tree;
import edu.jhu.coe.syntax.Trees;
import edu.jhu.coe.syntax.TreeJPanel;
...
//    		if (sentence.size()==0) { outputData.write("\n"); continue; }//break;
  ...
  /**
	...
	private static void outputTrees(List<Tree<String>> parseTrees, PrintWriter outputData, 
			CoarseToFineMaxRuleParser parser, edu.jhu.coe.PCFGLA.BerkeleyParser.Options opts) {
