...
public class PriorityQueue<E> implements Iterator<E>, Serializable, Cloneable, PriorityQueueInterface<E> {
	...
	/* (non-Javadoc)
	 * @see edu.jhu.coe.util.PriorityQueueInterface#hasNext()
	 */
	...
	/* (non-Javadoc)
	 * @see edu.jhu.coe.util.PriorityQueueInterface#next()
	 */
	public E next() {
		E first = peek();
		removeFirst();
	...
	/* (non-Javadoc)
	 * @see edu.jhu.coe.util.PriorityQueueInterface#remove()
	 */
	public void remove() {
	...
	/* (non-Javadoc)
	 * @see edu.jhu.coe.util.PriorityQueueInterface#peek()
	 */
	public E peek() {
	...
	/* (non-Javadoc)
	 * @see edu.jhu.coe.util.PriorityQueueInterface#getPriority()
	 */
	...
	/* (non-Javadoc)
	 * @see edu.jhu.coe.util.PriorityQueueInterface#size()
	 */
	public int size() {
		return size;
	}
	...
	/* (non-Javadoc)
	 * @see edu.jhu.coe.util.PriorityQueueInterface#isEmpty()
	 */
	...
	/* (non-Javadoc)
	 * @see edu.jhu.coe.util.PriorityQueueInterface#add(E, double)
	 */
